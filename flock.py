...
Usage (inside `crash`, on the box with the actual vmcore):
    epython flock.py -l <req_lock_addr> -b <bl_lock_addr>
    epython flock.py -l 0xffff8be8ec9ada00 -b 0xffff8bdd37636400
...
Finding candidate req/bl_lock addresses:
    ...
    (waiting) lock as -l and a granted/conflicting lock as -b, exactly as
...
if __name__ == '__main__':
    ...
    parser.add_argument("-l", "--lock", dest="lock", required=True,
    ...
    flock_deadlock_check(int(args.lock, 16), int(args.bl, 16), args.max_iter)
